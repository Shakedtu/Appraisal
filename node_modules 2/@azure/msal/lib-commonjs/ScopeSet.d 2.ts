export declare class ScopeSet {
   ...
   * @param scopes
   */
  static isIntersectingScopes(
    cachedScopes: Array<string>,
    scopes: Array<string>
  ): boolean;
  /**
   ...
   */
  static appendScopes(
    reqScopes: Array<string>,
    reqExtraScopesToConsent: Array<string>
  ): Array<string>;
}
